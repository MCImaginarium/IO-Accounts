...
public final class Main extends JavaPlugin {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if (cmd.getName().equalsIgnoreCase("website") && p.hasPermission("accounts.website")) {
            ...
            return true;
        } else if (cmd.getName().equalsIgnoreCase("vote") && p.hasPermission("accounts.vote")) {
            ...
            return true;
        } else if (cmd.getName().equalsIgnoreCase("forums") && p.hasPermission("accounts.forums")) {
            ...
            return true;
        } else if (cmd.getName().equalsIgnoreCase("shop") && p.hasPermission("accounts.shop")) {
            ...
            return true;
        } else if (cmd.getName().equalsIgnoreCase("voice") && p.hasPermission("accounts.voice")) {
            ...
            return true;
        } else if (cmd.getName().equalsIgnoreCase("map") && p.hasPermission("accounts.dynmap")) {
            ...
            return true;
        } else if (cmd.getName().equalsIgnoreCase("wiki") && p.hasPermission("accounts.wiki")) {
            ...
            return true;
        } else if (cmd.getName().equalsIgnoreCase("facebook") && p.hasPermission("accounts.facebook")) {
            ...
            return true;
        } else if (cmd.getName().equalsIgnoreCase("twitter") && p.hasPermission("accounts.twitter")) {
            ...
            return true;
        } else if (cmd.getName().equalsIgnoreCase("youtube") && p.hasPermission(("accounts.youtube"))) {
            ...
            return true;
        } else if (cmd.getName().equalsIgnoreCase("google+") && p.hasPermission("accounts.googleplus")) {
            ...
            return true;
        } else if (cmd.getName().equalsIgnoreCase("instagram") && p.hasPermission("accounts.instagram")) {
            ...
            return true;
        } else if (cmd.getName().equalsIgnoreCase("link") && p.hasPermission("accounts.link")) {
            ...
            return true;
        } else if (cmd.getName().equalsIgnoreCase("accounts")) {
            if (args.length != 1) {
                return false;
            } else if (args[0].equalsIgnoreCase("reload") && p.hasPermission("accounts.reload")) {
                this.reloadConfig();
